                                                ...
                                                for($i=0; $i<count($tab_user_app); $i++){
                                                    echo'
                                                        <tr>
                                                                ...
                                                                <div class="user-profile" style="width:100%;">
                                                                    <div class="profile-img" style="width:100%;">';
                                                                        if($tab_user_app[$i]['photo_path'] == ""){
                                                                            ...
                                                                            echo '<img src="on_demand_taxi_webservice/images/app_user/'.$tab_user_app[$i]['photo_path'].'" alt="" width="100%" style="width:70px;height:70px;">';
                                                                        }
                                                            ...
                                                            <td><span class="'; if($tab_user_app[$i]['statut'] == "yes"){echo "badge badge-success";}else{echo "badge badge-danger";} echo '">'.$tab_user_app[$i]['statut'].'</span></td>
