                                                ...
                                                for($i=0; $i<count($tab_location); $i++){
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td><span class="'; if($tab_location[$i]['statut'] == "accepted"){echo "badge badge-success";}
                                                            else if($tab_location[$i]['statut'] == "in progress"){echo "badge badge-warning";}
                                                            else if($tab_location[$i]['statut'] == "refuse"){echo "badge badge-danger";}
                                                            else{echo "badge badge-inverse";}
                                                            echo '"'; if($tab_location[$i]['statut'] == "fenced"){echo 'style="color:#fff;"';} echo '>'.$tab_location[$i]['statut'].'</span></td>
