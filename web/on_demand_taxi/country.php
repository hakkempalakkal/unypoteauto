                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="country-mod" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content bg-gris">
                                            <div class="modal-header">
                                                ...
                                                for($i=0; $i<count($tab_country); $i++){
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td><span class="'; if($tab_country[$i]['statut'] == "yes"){echo "badge badge-success";}else{echo "badge badge-danger";} echo '">'.$tab_country[$i]['statut'].'</span></td>
