                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-1 m-t-30">
                                        <button type="submit" class="btn btn-dark waves-effect" style="height:37px;" onclick="apply(customer.value,month.value,year.value)"><?php echo $apply; ?></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                ?>
                                <h4 class="card-title"><?php echo $customer_stats; ?> (<?php echo $tab_currency[0]['symbole']; ?>)</h4>
                                <div class="row">
