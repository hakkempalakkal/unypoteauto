                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-10">
                                    <?php
                                        $tab_requete[] = array();
                                        $tab_requete = getRequeteCompleted();
                                        $tab_currency[] = array(); 
                                    ...
                                    <table id="example24" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo $earning; ?> (<?php echo $tab_currency[0]['symbole'] ?>)</th>
                                                <!-- <th>Path</th> -->
                                            ...
                                            <?php
                                                for($i=0; $i<count($tab_requete); $i++){
                                                    ...
                                                    echo'
                                                        <tr>
                                                            <td>'.($i+1).'</td>
                                                            <td><span class="'; if($tab_requete[$i]['statut_paiement']=='yes'){echo 'badge badge-success'; $statut_pay='Paid';}else{echo 'badge badge-warning'; $statut_pay='Not paid';} echo '">'.$statut_pay.'</span></td>
