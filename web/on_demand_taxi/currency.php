                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content bg-gris">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel"><?php echo $add_a_currency; ?></h4>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control " placeholder="" name="libelle_currency" required> 
                                                            ...
                                                            <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation"><?php echo $symbol; ?></label>
                                                                    <input type="text" class="form-control " placeholder="" name="symbole_currency" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                ...
                                <div id="currency-mod" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content bg-gris">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel"><?php echo $modify_a_currency; ?></h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <form class="form-horizontal " action="query/action.php" method="post">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <input type="hidden" name="id_currency_mod" id="id_currency_mod" value="<?php echo $id_user; ?>">
                                                            <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation"><?php echo $name; ?></label>
                                                                    <input type="text" class="form-control " placeholder="" name="libelle_currency_mod" id="libelle_currency_mod" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation"><?php echo $symbol; ?></label>
                                                                    <input type="text" class="form-control " placeholder="" name="symbole_currency_mod" id="symbole_currency_mod" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                                ...
                                                for($i=0; $i<count($tab_currency); $i++){
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td><span class="'; if($tab_currency[$i]['statut'] == "yes"){echo "badge badge-success";}else{echo "badge badge-danger";} echo '">'.$tab_currency[$i]['statut'].'</span></td>
