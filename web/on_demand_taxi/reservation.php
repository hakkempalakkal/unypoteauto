                                                ...
                                                for($i=0; $i<count($tab_reservation); $i++){
                                                    ...
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td><span class="';
                                                            if($tab_reservation[$i]['statut'] == "en cours"){echo "badge badge-warning";}
                                                            else if($tab_reservation[$i]['statut'] == "accepter"){echo "badge badge-success";}
                                                            else if($tab_reservation[$i]['statut'] == "clôturer"){echo "badge badge-dark";}
                                                            else{echo "badge badge-danger";}
