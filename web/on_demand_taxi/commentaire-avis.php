                        ...
                        <div class="card">
                            <div class="card-body">                            
                                ...
                                <ul class="nav nav-pills m-t-0 m-b-30" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#commentaire" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down"><i class="mdi mdi-comment m-r-5"></i>Commentaire</span> </a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#avis" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down"><i class="fa fa-star m-r-5"></i>Avis</span></a> </li>
                                </ul>
                                <!-- Tab panes -->
                                                        ...
                                                        for($i=0; $i<count($tab_commentaire); $i++){
                                                            echo'
                                                                <tr>
                                                                    ...
                                                                    <td><span class="'; if($tab_commentaire[$i]['statut'] == "yes"){echo "badge badge-success";}else{echo "badge badge-danger";} echo '">'.$tab_commentaire[$i]['statut'].'</span></td>
