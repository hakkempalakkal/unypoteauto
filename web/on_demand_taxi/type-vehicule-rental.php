...
<body class="fix-header card-no-border">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-dark btn-sm" data-toggle="modal" data-target="#add-type-vehicule"><i class="fa fa-plus m-r-10"></i><?php echo $add ?></button>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control " placeholder="" name="libelle_type_vehicule_rental" required> 
                                                            ...
                                                            <!-- <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control " placeholder="" name="price_vehicule_rental" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="modal-content bg-gris">
                                            ...
                                            <form class="form-horizontal " action="query/action.php" method="post" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <input type="hidden" name="id_type_vehicule_rental_mod" id="id_type_vehicule_rental_mod" value="<?php echo $id_user; ?>">
                                                            <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation"><?php echo $name ?></label>
                                                                    <input type="text" class="form-control " placeholder="" name="libelle_type_vehicule_rental_mod" id="libelle_type_vehicule_rental_mod" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <!-- <div class="col-md-12 m-b-0">
                                                                <div class="form-group mb-3">
                                                                    <label class="mr-sm-2" for="designation">Price</label>
                                                                    <input type="text" class="form-control " placeholder="" name="price_vehicule_rental_mod" id="price_vehicule_rental_mod" required> 
                                                                    <div class="invalid-feedback">
                                                                        Désolé, entrez l'intitulé de la catégorie de devis
                                                                    </div>
                                                                </div>
                                                ...
                                                for($i=0; $i<count($tab_type_vehicule); $i++){
                                                    echo'
                                                        <tr>
                                                            ...
                                                            <td width="10%"><img width="100%" src="assets/images/type_vehicle_rental/'.$tab_type_vehicule[$i]['image'].'" alt=""></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="query/action.php?id_type_vehicule_rental='.$tab_type_vehicule[$i]['id'].'" class="btn btn-danger btn-sm" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash"></i> </a>
                                                            </td>
                                                        </tr>
                                                    ';
                                                }
    ...
    <script>
        function modTypeVehicule(id_type){
            $.ajax({
                url: "query/ajax/getTypeVehiculeRentalById.php",
                type: "POST",
