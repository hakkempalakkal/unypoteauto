<?php
  ...
  include_once 'GCM.php';
    ...
    if($_SERVER['REQUEST_METHOD'] =='POST'){
        ...
        VALUES('$date_retour','$statut_round','$heure_retour',$number_poeple,'$place',$id_payment,'$image_name','$depart_name','$destination_name',$id_conducteur,$user_id,'$lat1','$lng1','$lat2','$lng2','new','$date_heure',$distance,$cout,'$duree')";
