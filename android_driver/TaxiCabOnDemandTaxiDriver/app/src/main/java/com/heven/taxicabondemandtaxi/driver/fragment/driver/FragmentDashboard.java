...
//    private static String today;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(M.getCountry(context).equals("All"))
            MainActivity.setTitle(getResources().getString(R.string.dashboard__));
        else
            MainActivity.setTitle(getResources().getString(R.string.dashboard__)+" - "+M.getCountry(context));
