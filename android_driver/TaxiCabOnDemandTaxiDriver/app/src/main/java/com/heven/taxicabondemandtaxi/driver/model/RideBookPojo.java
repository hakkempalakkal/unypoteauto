package com.heven.taxicabondemandtaxi.driver.model;
...
public class RideBookPojo {
    ...
    public RideBookPojo(int id, int user_id, int conducteur_id, String user_name, String conducteur_name, String distance, String date, String statut,
            ...
            , String trajet, String driver_phone, String customer_phone, String statut_paiement
            , String date_book, String cu_ride, String heure_depart, String nb_day, String payment_method, String img_payment_method, String place, String number_poeple
            , String heure_retour, String statut_round) {
        this.id = id;
    ...
    public void setCu_ride(String cu_ride) {
        this.cu_ride = cu_ride;
    }
    ...
    public void setNb_day(String nb_day) {
        this.nb_day = nb_day;
    }
