...
public class HorizontalPicker extends LinearLayout implements HorizontalPickerListener {
    ...
    public static void setVisibilityGone(){
        baseView.setVisibility(INVISIBLE);
    }
    ...
    public void init() {
        ...
        tvMonth.setTextColor(mMonthAndYearTextColor != -1 ? mMonthAndYearTextColor : getColor(Color.GRAY));
        tvToday.setVisibility(showTodayButton ? VISIBLE : INVISIBLE);
        tvToday.setTextColor(mTodayButtonTextColor != -1 ? mTodayButtonTextColor : getColor(Color.GRAY));
        ...
        mTodayDateTextColor = mTodayDateTextColor == -1 ? Color.GRAY : mTodayDateTextColor;
        mDayOfWeekTextColor = mDayOfWeekTextColor == -1 ? Color.GRAY : mDayOfWeekTextColor;
        mUnselectedDayTextColor = mUnselectedDayTextColor == -1 ? getColor(R.color.white) : mUnselectedDayTextColor;
        rvDays.init(
                getContext(),
                finalDays,
                finalOffset,
