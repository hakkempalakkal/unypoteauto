package com.heven.taxicabondemandtaxi.driver.fragment;
...
public class FragmentProfile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(M.getCountry(context).equals("All"))
            MainActivity.setTitle(getResources().getString(R.string.my_profile__));
        else
            MainActivity.setTitle(getResources().getString(R.string.my_profile__)+" - "+M.getCountry(context));
