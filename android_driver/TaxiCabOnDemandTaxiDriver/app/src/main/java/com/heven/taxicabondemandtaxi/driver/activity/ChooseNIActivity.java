...
public class ChooseNIActivity extends BaseActivity {
    ...
    public static ImageView ni_photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_ni);

        Bundle objetbundle = this.getIntent().getExtras();
        id_driver = objetbundle.getString("id_driver");

        context = ChooseNIActivity.this;
        select_photo = (TextView)findViewById(R.id.select_photo);
        ni_photo = (ImageView) findViewById(R.id.ni_photo);
...
//                    progressBar_login.setVisibility(View.VISIBLE);
    ...
    /** Enregistrement d'une photo de la carte d'identité national d'un conducteur**/
                            ...
                            try {
                                ...
                                if(etat.equals("1")){
                                    if(!msg.getString("image").equals("")) {
                                        ...
                                        Intent intent = new Intent(ChooseNIActivity.this, ChooseLicenceActivity.class);
                                    ...
                                    ni_photo.setImageBitmap(bitmap_anc);
                                }
...
//        Toast.makeText(context, ""+getFileName(filePath), Toast.LENGTH_SHORT).show();
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            if(bitmap_anc != null)
                bitmap_anc = ((BitmapDrawable) ni_photo.getDrawable()).getBitmap();
...
//            Toast.makeText(context, ""+getStringImage(bitmap), Toast.LENGTH_SHORT).show();
            ...
            ni_photo.setImageBitmap(bitmap);
