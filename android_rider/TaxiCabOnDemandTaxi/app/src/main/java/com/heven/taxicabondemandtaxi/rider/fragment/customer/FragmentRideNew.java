...
import com.heven.taxicabondemandtaxi.rider.adapter.RideAdapter;
import com.heven.taxicabondemandtaxi.rider.controller.AppController;
import com.heven.taxicabondemandtaxi.rider.model.M;
import com.heven.taxicabondemandtaxi.rider.model.RidePojo;
...
public class FragmentRideNew extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(M.getCountry(context).equals("All"))
            MainActivity.setTitle(getResources().getString(R.string.item_new));
        else
            MainActivity.setTitle(getResources().getString(R.string.item_new)+" - "+M.getCountry(context));
...
//                .enableAutoManage(getActivity(), this)
        ...
        adapter_ride = new RideAdapter(context, albumList_ride, getActivity(), "RideNew");
                    ...
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(etat.equals("1")){
                                    adapter_ride.delete(Integer.parseInt(position));
                                ...
                                if(etat.equals("1")){
                                    ...
                                    for(int i=0; i<(msg.length()-1); i++) {
                                        ...
                                        albumList_ride.add(new RidePojo(taxi.getInt("id"),taxi.getInt("id_user_app"),taxi.getInt("id_conducteur"), taxi.getString("nom")+" "+taxi.getString("prenom"), taxi.getString("nomConducteur")+" "+taxi.getString("prenomConducteur"), taxi.getString("distance"),taxi.getString("creer"),taxi.getString("statut"),taxi.getString("latitude_depart")
                                                ...
                                                ,taxi.getString("niveau"),taxi.getString("moyenne"),taxi.getString("nb_avis"),taxi.getString("montant"),taxi.getString("duree"),taxi.getString("depart_name"),taxi.getString("destination_name"),taxi.getString("trajet"),taxi.getString("driverPhone"),taxi.getString("phone")
                                                ,taxi.getString("statut_paiement") ,taxi.getString("payment"),taxi.getString("payment_image"),taxi.getString("place"),taxi.getString("number_poeple"),taxi.getString("heure_retour"),taxi.getString("statut_round"),taxi.getString("date_retour"),taxi.getString("photo_path"),taxi.getString("comment")));
                                        adapter_ride.notifyDataSetChanged();
                                    }
                                }else{
