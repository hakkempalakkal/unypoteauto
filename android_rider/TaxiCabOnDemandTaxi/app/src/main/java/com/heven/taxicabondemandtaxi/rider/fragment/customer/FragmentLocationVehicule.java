...
import com.heven.taxicabondemandtaxi.rider.adapter.VehiculeAdapter;
import com.heven.taxicabondemandtaxi.rider.controller.AppController;
import com.heven.taxicabondemandtaxi.rider.model.M;
import com.heven.taxicabondemandtaxi.rider.model.VehiculePojo;
...
public class FragmentLocationVehicule extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(M.getCountry(context).equals("All"))
            MainActivity.setTitle(getResources().getString(R.string.item_louer_vehicule));
        else
            MainActivity.setTitle(getResources().getString(R.string.item_louer_vehicule)+" - "+M.getCountry(context));
