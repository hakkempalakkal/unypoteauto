...
import com.heven.taxicabondemandtaxi.rider.adapter.LocationAdapter;
import com.heven.taxicabondemandtaxi.rider.controller.AppController;
import com.heven.taxicabondemandtaxi.rider.model.LocationPojo;
...
public class FragmentMyLocationVehicule extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(M.getCountry(context).equals("All"))
            MainActivity.setTitle(getResources().getString(R.string.item_vehicule_loue));
        else
            MainActivity.setTitle(getResources().getString(R.string.item_vehicule_loue)+" - "+M.getCountry(context));
